...
| 환경     | 지표 | 개선 전 | 개선 후 | 평가             |
| -------- | ---- | ------- | ------- | ---------------- |
| 모바일   | FCP  | 3,500ms | 1,200ms | 개선 필요 → 좋음 |
|          | LCP  | 4,070ms | 1,400ms | 나쁨 → 좋음      |
|          | TBT  | 1,700ms | 10ms    | 나쁨 → 좋음      |
|          | CLS  | 0.25    | 0.001   | 개선 필요 → 좋음 |
| 데스크톱 | FCP  | 1,000ms | 300ms   | 좋음 → 좋음      |
|          | LCP  | 2,760ms | 700ms   | 개선 필요 → 좋음 |
|          | TBT  | 700ms   | 0ms     | 개선 필요 → 좋음 |
|          | CLS  | 0.12    | 0.002   | 좋음 → 좋음      |
